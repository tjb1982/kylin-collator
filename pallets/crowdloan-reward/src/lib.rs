// Copyright 2021 Kylin Network (kylin.network).
// This file is part of Kylin chain project.

// Kylin is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version (see http://www.gnu.org/licenses).

// Kylin is distributed in the hope that it will be useful,
...
//!
//! ## Overview
//! The function of this pallet is to provide the kylin-specific reward functionality for
...
//! please refer to the [pallet' specification document](s).
//!
//! ## Goals
//!
//! ## Usage
...
//!
//! ## Credits
//! Frederik Schulz <frederik@kylin.network>
	...
	BalanceOf<T>: Send + Sync,
{
	...
	fn reward(
		...
		let schedule = pallet_vesting::VestingInfo::new(vested_reward, per_block, Self::vesting_start()
